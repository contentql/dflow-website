...
dFlow lets you connect your AWS account and manage your cloud infrastructure
directly from the dFlow interface. You can create, update, and delete resources,
as well as monitor their status and logs—all in one place.

## Connect your AWS account

To connect your AWS account, follow these steps:

1. Navigate to [**Integrations**](https://demo.dflow.sh/integrations) section in
   dFlow.
...
<Callout type='info'>
  ...
  dFlow permission to create and manage EC2 instances.
</Callout>
...
13. Copy the **Access key ID** and **Secret access key**—you'll need these to
    connect your account to dFlow.

<Callout type='warn'>
  Currently, dFlow supports creating new EC2 instances only. Support for
