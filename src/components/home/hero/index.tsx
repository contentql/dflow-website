...
export function HeroSection() {
  ...
  return (
    <div className='bg-grid-white/[0.02] relative mx-auto flex h-[32rem] sm:h-[40rem] max-w-7xl flex-col items-center justify-center overflow-hidden rounded-md antialiased px-4 md:px-6 lg:px-8'>
      <Spotlight
      ...
      <div className='relative z-10 mx-auto w-full text-center pt-20 sm:pt-28'>
        ...
        <div>
          <div className='mt-6 flex items-center gap-4 justify-center'>
            ...
            <Button
              ...
              variant='outline'
              className='hover:bg-card hover:text-foreground flex items-center gap-2'>
              <svg
                role='img'
